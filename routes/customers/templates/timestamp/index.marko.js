...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/server$0.0.0/routes/customers/templates/timestamp/index.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<!doctype html><html lang=\"en\"><head><meta charset=\"UTF-8\"><title>Welcome | Customer Timestamp(s)</title></head><body>");
...
marko_template.meta = {
    id: "/server$0.0.0/routes/customers/templates/timestamp/index.marko",
    tags: [
